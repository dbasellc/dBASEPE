...
//      return nMaxWidth
   ...
   function resizeProjectPage
      ...
      this.Notebook.PARAMETERS.width := this.Notebook.PARAMETERS.width+this.DeltaWidth
		Msgbox("BEFORE CHANGE : this.Notebook.PREPROCESSORS.width = "+this.Notebook.PREPROCESSORS.width)
		this.Notebook.PREPROCESSORS.width := this.Notebook.PREPROCESSORS.width+this.DeltaWidth
		Msgbox("AFTER CHANGE : this.Notebook.PREPROCESSORS.width = "+this.Notebook.PREPROCESSORS.width)
