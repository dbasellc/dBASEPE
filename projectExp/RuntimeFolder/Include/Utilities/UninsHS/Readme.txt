...
=======================
  ...
  * Here are the supported languages: 
    ...
    French(fr), Russian(ru), Ukrainian(uk)
...
===================
  ...
  * Add this line if you want an uninstall icon in the start menu
    ...
    ; Customize this line with your AppName and AppId (If you don't use AppId,
      customize the AppId with your AppName )
...
=================
  ...
  * Add this line ( If the DestDir of UninsHs is not {app} in [Files] section,
    ...
    Filename: {app}\UninsHs.exe; \
       Parameters: /r=AppId,{language},{srcexe}; Flags: runminimized
  ...
  * Or if you want to copy your installation package to a specified directory
    ...
    Filename: {app}\UninsHs.exe; \
      Parameters: /r=AppId,{language},{srcexe},YourDirFile; \
    ...
    ;Example:
     ...
     [Dir]
        Name: "{userappdata}\$Han-soft$"; \
           Attribs: hidden; Flags: uninsalwaysuninstall
     [Run]
        Filename: "{app}\UninsHs.exe"; \
          Parameters: /r=MyAppId,{language},{srcexe},{userappdata}\$Hs$\i.exe; \
          WorkingDir: "{app}"; \
...
Portuguese(Portugal) by José Sousa (jjss@aeiou.pt)
...
================================================================================
$Rev: 86 $  $Id: Readme.txt 86 2006-01-14 21:19:35Z hanjy $
